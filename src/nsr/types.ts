...
export interface LanguageUsageStructure {
  language: string;
  languageUse: ("NORMALLY_USED" | "UNDERSTOOD" | "NATIVE" | "SPOKEN" | "WRITTEN" | "READ" | "OTHER" | "ALL_USES")[];
}
...
export interface StopPlace {
  ...
  accessModes?: ("FOOT" | "BICYCLE" | "BOAT" | "CAR" | "TAXI" | "SHUTTLE" | "SKI" | "SKATE")[];
  nameSuffix?: MultilingualString;
  alternativeNames?: AlternativeNamesRelStructure;
  crossRoad?: MultilingualString;
  landmark?: MultilingualString;
  publicUse?: "ALL" | "DISABLED_PUBLIC_ONLY" | "AUTHORISED_PUBLIC_ONLY" | "STAFF_ONLY" | "PUBLIC_ONLY";
  ...
  siteType?: "SCHOOL" | "UNIVERSITY" | "WORKS" | "OFFICE" | "MILITARY_BASE" | "RETAIL" | "OTHER";
  atCentre?: boolean;
  ...
  coachSubmode?:
    ...
    | "TOURIST_COACH"
    | "COMMUTER_COACH";
  funicularSubmode?: "UNKNOWN" | "FUNICULAR" | "STREET_CABLE_CAR" | "ALL_FUNICULAR_SERVICES" | "UNDEFINED_FUNICULAR";
  ...
  waterSubmode?:
    ...
    | "CANAL_BARGE";
  snowAndIceSubmode?: "UNKNOWN" | "UNDEFINED" | "SNOW_MOBILE" | "SNOW_CAT" | "SNOW_COACH" | "TERRA_BUS" | "WIND_SLED";
  otherTransportModes?: (
    | "AIR"
    | "BUS"
    | "COACH"
  ...
  limitedUse?:
    ...
    | "LIMITED_SERVICE"
    | "OTHER";
  weighting?: "NO_INTERCHANGE" | "INTERCHANGE_ALLOWED" | "RECOMMENDED_INTERCHANGE" | "PREFERRED_INTERCHANGE";
...
export interface ParkingProperties {
  ...
  parkingStayList?: ("SHORT_STAY" | "MID_TERM" | "LONG_TERM" | "DROPOFF" | "UNLIMITED" | "OTHER" | "ALL")[];
  maximumStay?: {
    seconds?: number;
    units?: {
      duration?: { seconds?: number; zero?: boolean; negative?: boolean; nano?: number };
...
export interface FareZone {
  ...
  zoneTopology?:
    ...
    | "OTHER";
  scopingMethod?: "EXPLICIT_STOPS" | "IMPLICIT_SPATIAL_PROJECTION" | "EXPLICIT_PERIPHERY_STOPS" | "OTHER";
...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "https://api.entur.io/stop-places/v1/read";
